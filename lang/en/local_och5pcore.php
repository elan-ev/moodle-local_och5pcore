...
$string['setting_search_endpoint_header'] = 'Search Endpoint Configuration';
$string['setting_opencast_instance'] = 'Opencast Instance For Search Endpoint';
$string['setting_opencast_instance_desc'] = 'The opencast instance configured in tool opencast plugin to be used for accessing the "/search/episode.json" endpoint.';
$string['setting_opencast_instance_default_name_option'] = 'Opencast Instance';
$string['setting_opencast_instance_default_indicator'] = 'Default';
