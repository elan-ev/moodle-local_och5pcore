(function ($) {
    ...
    function loadStrings() {
        ...
        H5PEditor.language.och5pcore.libraryStrings = opencastLanguage;
    }
    ...
    function getCourseVideosInsertDropdown() {
        ...
        if (action == 'courseVideos') {
            dropdownDisplay = '<div class="field select">' +
                '<label for="h5p-oc-course-videos" class="h5peditor-label">' + H5PEditor.t('och5pcore', 'label_video_file') + '</label>' +
                '<select id="h5p-oc-course-videos" class="h5peditor-select h5p-oc-videos-selection">' + dropdownContent + '</select>' +
            '</div>';
        } else {
            dropdownDisplay = '<div class="field select">' +
                '<label for="h5p-oc-course-list" class="h5peditor-label">' + H5PEditor.t('och5pcore', 'label_course') + '</label>' +
                ...
                '<div class="h5p-add-dialog-table">' +
                    '<div class="h5p-oc-dialog-box">' +
                        '<div class="h5p-oc-logo-header">' +
                            '<h3 class="h5p-oc-header-text">' + H5PEditor.t('och5pcore', 'header_text') + '</h3>' +
                        '</div>' +
                        '<div class="h5p-oc-video-wrapper">' +
                            dropdownDisplay +
                            '<div class="field select" style="display: none;">' +
                                '<label for="h5p-oc-video-quality" class="h5peditor-label">' + H5PEditor.t('och5pcore', 'label_video_flavor') + '</label>' +
